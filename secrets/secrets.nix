let
  ...
  erika = {
    fuchsia = "sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAIEu9QzwNxSReeVkr/8ChHfwValDjZ1xYiPHP/E04n5c3AAAABHNzaDo=";
  };
  ...
  users = [ sabrina.viridian erika.fuchsia];
